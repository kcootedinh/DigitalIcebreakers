...
namespace DigitalIcebreakers.Test
{
    public class MockGameHub : GameHub
    {
        ...
        public MockGameHub(List<Lobby> lobbys, string connectionId) 
            : base(new Mock<ILogger<GameHub>>().Object, ObjectMother.GetLobbyManager(lobbys), new Mock<IOptions<AppSettings>>().Object, new ClientHelper(ObjectMother.GetMockContext().Object))
        {
